      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-800 via-blue-700 to-indigo-700 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 lg:px-16">
          ...
          <h2 className="text-3xl lg:text-4xl font-extrabold text-white leading-tight">
            Ship smarter, <br />pay securely
          </h2>
          <p className="mt-4 text-blue-100 text-lg max-w-md">
            Post loads, receive competitive bids from verified couriers, and pay
            securely through our Mobile Money escrow system. Track every
          ...
          <div className="mt-10 grid grid-cols-2 gap-4">
            {[
              ...
              { stat: "94.7%", label: "On-time delivery rate" },
              { stat: "16", label: "Regions covered" },
              { stat: "GHS 0", label: "Platform fees to start" },
            ].map((b) => (
        ...
        <div className="w-full max-w-md">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div className={`flex items-center gap-2 ${step >= 2 ? "text-brand-600" : "text-gray-400"}`}>
              ...
              <span className="text-sm font-medium">Contact & Security</span>
            </div>
          </div>

          <h1 className="text-2xl font-bold text-gray-900">Create shipper account</h1>
          <p className="mt-1 text-sm text-gray-500">
            {step === 1
              ? "Tell us about your business"
              : "Set up your contact info and password"}
          </p>
            ...
            {step === 1 ? (
              <>
                <div>
                  ...
                  <input type="text" className="input" placeholder="Ama Mensah" value={form.fullName} onChange={(e) => update("fullName", e.target.value)} />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input type="email" className="input" placeholder="ama@enterprise.com" value={form.email} onChange={(e) => update("email", e.target.value)} />
                </div>
              </>
            ) : (
              <>
                ...
                <label className="flex items-start gap-2 mt-2 cursor-pointer">
                  ...
                  <span className="text-xs text-gray-500">
                    ...
                    <span className="text-brand-600 hover:underline cursor-pointer">Privacy Policy</span>, and{" "}
                    <span className="text-brand-600 hover:underline cursor-pointer">Escrow Agreement</span>
                  </span>
                </label>
              </>
            )}
          ...
          <p className="mt-6 text-center text-sm text-gray-500">
            ...
            <Link href="/shipper/login" className="font-semibold text-brand-600 hover:text-brand-700 transition">
              Log in
            </Link>
          </p>
          ...
          <p className="mt-3 text-center text-xs text-gray-400">
            Are you a courier?{" "}
            <Link href="/courier/signup" className="text-brand-600 hover:underline">
              Sign up as a courier instead
            </Link>
          </p>
        </div>
      </div>
