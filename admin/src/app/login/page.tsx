...
export default function AdminLoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    /* In production this would hit the API. For now, demo credentials. */
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-900 px-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8">
          <div className="h-14 w-14 rounded-xl bg-brand-600 flex items-center justify-center mb-4 shadow-lg shadow-brand-600/20">
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-2xl p-6 sm:p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                type="email"
                className="block w-full rounded-lg border border-gray-600 bg-gray-700 px-3.5 py-2.5 text-sm text-white shadow-sm placeholder:text-gray-500 focus:border-brand-500 focus:ring-1 focus:ring-brand-500 transition"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="block w-full rounded-lg border border-gray-600 bg-gray-700 px-3.5 py-2.5 pr-10 text-sm text-white shadow-sm placeholder:text-gray-500 focus:border-brand-500 focus:ring-1 focus:ring-brand-500 transition"
          ...
          <div className="mt-6 pt-4 border-t border-gray-700">
            <p className="text-xs text-gray-500 text-center">
              Demo credentials: <span className="text-gray-400">admin@loadmovegh.com</span> / <span className="text-gray-400">admin2026</span>
            </p>
          </div>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-gray-500">
          <a href="https://www.loadmovegh.com" className="text-brand-400 hover:text-brand-300 transition">
