      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-800 via-blue-700 to-indigo-700 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 lg:px-16">
          ...
          <p className="mt-4 text-blue-100 text-lg max-w-md">
            ...
            shipments, and manage payments — all in one place.
          </p>

          {/* Feature highlights */}
          <div className="mt-12 space-y-4">
            {[
              { icon: "📦", title: "Post loads in seconds", desc: "AI suggests optimal pricing for your route" },
              { icon: "🔒", title: "Escrow protection", desc: "Payment released only after confirmed delivery" },
              { icon: "📍", title: "Real-time tracking", desc: "GPS tracking across all 16 regions of Ghana" },
            ].map((f) => (
