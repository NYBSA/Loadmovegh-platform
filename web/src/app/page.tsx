      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <section id="auth" ref={authRef} className="py-16 scroll-mt-24">
          <div className="mx-auto max-w-xl">
            ...
            {/* ── Trust & Help Section (below auth form) ── */}
            <div className="mt-8 space-y-5">
              {/* Help link */}
              <p className="text-center text-sm text-gray-500">
                If you are unable to {authMode === "login" ? "login" : "sign up"}, please visit our{" "}
                <a href="mailto:support@loadmovegh.com" className="font-medium text-brand-600 hover:text-brand-700 underline underline-offset-2 transition">
                  help centre
                </a>.
              </p>
              ...
              <div className="flex flex-wrap items-center justify-center gap-5">
                ...
                <div className="flex items-center gap-2 rounded-full bg-blue-50 border border-blue-200 px-4 py-2">
                  ...
                  <span className="text-xs font-semibold text-blue-700">Escrow Protected</span>
                </div>

                {/* MoMo verified badge */}
                <div className="flex items-center gap-2 rounded-full bg-yellow-50 border border-yellow-200 px-4 py-2">
                  <span className="text-sm">🇬🇭</span>
                  <span className="text-xs font-semibold text-yellow-700">MoMo Verified</span>
                </div>
              </div>

              {/* Browser recommendation + data protection */}
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 text-xs text-gray-400">
                <div className="flex items-center gap-1.5">
                  ...
                  <span>Works best on Chrome, Firefox &amp; Safari</span>
                </div>
                <span className="hidden sm:inline">|</span>
                <div className="flex items-center gap-1.5">
                  <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M7.864 4.243A7.5 7.5 0 0 1 19.5 10.5c0 2.92-.556 5.709-1.568 8.268M5.742 6.364A7.465 7.465 0 0 0 4.5 10.5a48.667 48.667 0 0 0-1.432 8.268m11.196-4.768a6 6 0 1 0-8.528 0" />
                  </svg>
                  <span>Your data is protected under Ghana&apos;s Data Protection Act</span>
                </div>
              </div>
            </div>
          </div>
